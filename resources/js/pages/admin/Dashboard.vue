    ...
    <div class="flex grow flex-col">
        <div class="wrapper frosted-backdrop h-full p-2">
            <div class="mb-6 grid grid-cols-4 gap-6">
                <div
                    class="rounded-xl border border-error/70 bg-base-100/15 p-6 text-error shadow-lg shadow-error/20 backdrop-blur-3xl"
                >
                    <div class="flex items-start justify-between">
                        <h2 class="text-sm font-semibold text-error uppercase">
                            Needs Attention
                        </h2>
                    ...
                    <ul class="mt-8 list-inside list-disc text-error">
                        <li
                            v-for="course in page.props.coursesNeedingAttention"
                            :key="course.id"
                        >
                            <button
                ...
                >
                    <div class="flex items-start justify-between">
                        <h2 class="text-sm font-semibold text-info uppercase">
